(function(j, h, c, g, d, k, e) { /*! Jssor */
    ...
    var b = j.$Jssor$ = new function() {
        ...
        function Ib() {
            if (!O) {
                O = {
                    fe: "ontouchstart" in j || "createTouch" in h
                };
                var a;
                if (E.pointerEnabled || (a = E.msPointerEnabled)) O.Vd = a ? "msTouchAction" : "touchAction"
            }
            return O
        }
        ...
        i.$GetElement = function(a) {
            if (i.Te(a)) a = h.getElementById(a);
            return a
        };
        ...
        i.Zd = m("backfaceVisibility", 4);
        i.ae = m("transformStyle", 4);
        i.de = m("perspective", 6);
        i.Ce = m("perspectiveOrigin", 4);
        i.ze = function(b, a) {
        ...
        i.Mf = function(d, a) {
            if (a) d.style.clip = "rect(" + c.round(a.$Top || a.C || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.B || 0) + "px)";
            else if (a !== e) {
        ...
        i.Ac = function(a) {
            i.of(i.$Children(a, d), a)
        };
        i.rc = function(a, b) {
            var c = i.Mc(a);
            b & 1 && i.J(a, (i.$CssWidth(c) - i.$CssWidth(a)) / 2);
            b & 2 && i.H(a, (i.$CssHeight(c) - i.$CssHeight(a)) / 2)
        };
        var W = {
            $Top: g,
            $Right: g,
        ...
        i.Fd = function(n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                if (w) {
                    ...
                    if (r() && l >= 11 && (j.B || j.C) && s != 0 && s != 1) a.$Rotate = a.$Rotate || 1e-8;
                    a.gg = d
                }
            }
            if (j.$Clip && o.$Move) {
            ...
            if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.C && !a.$Clip.B && a.$Clip.$Right == o.$OriginalWidth && a.$Clip.$Bottom == o.$OriginalHeight) a.$Clip = g;
            return a
        }
    };
    ...
    j.$JssorSlideshowRunner$ = function(m, s, p, u, z, A) {
        ...
        function j(h, e, g) {
            ...
            t(a);
            a.Xb = a.$Cols * a.$Rows;
            a.$Easing = b.Dc(a.$Easing, f.$Linear);
            a.rf = c.ceil(a.$Duration / a.$Interval);
            a.lf = function(c, b) {
                c /= a.$Cols;
                b /= a.$Rows;
                var f = c + "x" + b;
        ...
        function n(z, i, a, v, n, l) {
            ...
            b.$Each(o, function(i, m) {
                b.$Each(i, function(G) {
                    ...
                    h[v].wf = y + D - 1;
                    for (var F = 0; F <= D; F++) {
                        var E = b.Fd(f, r, F / D, a.$Easing, a.$During, a.$Round, {
                            $Move: a.$Move,
                            $OriginalWidth: n,
                            $OriginalHeight: l
                        });
    ...
    j.$JssorBulletNavigator$ = function(a, E) {
        ...
        f.Gc = function(x) {
            if (!w) {
                ...
                for (var f = 0; f < u; f++) {
                    var t = b.Pf();
                    b.$InnerText(t, f + 1);
                    var k = b.Vc(h, "numbertemplate", t, d);
                    b.Y(k, "absolute");
                    var p = f % (m + 1);
                    b.J(k, !i ? n * p : f % j * n);
                    b.H(k, i ? o * p : c.floor(f / (m + 1)) * o);
                    b.$AppendChild(a, k);
                    D[f] = k;
        ...
        z = e.$SpacingY;
        i = e.$Orientation - 1;
        e.$Scale == k && n.W(a, m.Pb, 1);
        e.$AutoCenter && n.W(a, m.rb, e.$AutoCenter);
        n.Ub(a)
    };
    j.$JssorArrowNavigator$ = function(a, e, i, A, z, x) {
        ...
        function u() {
            s.$Enable(i.$Loop || !j.xe(h));
            r.$Enable(i.$Loop || !j.ye(h))
        }
        c.Lc = function(c, a, b) {
            h = a;
            !b && u()
        ...
        if (f.$AutoCenter) {
            n.W(a, m.rb, f.$AutoCenter);
            n.W(e, m.rb, f.$AutoCenter)
        }
        n.Ub(a);
        n.Ub(e)
    };
    j.$JssorThumbnailNavigator$ = function(f, E) {
        ...
        function D(n, f) {
            ...
            h.sb = f;
            h.Hd = o;
            j = n.Ae || n.dc || b.$CreateDiv();
            h.jc = c = b.Vc(u, "thumbnailtemplate", j, d);
            m = b.mc(c);
        ...
        r = a.$SpacingY;
        j = a.$Cols;
        a.$Scale == k && n.W(f, m.Pb, 1);
        a.$AutoCenter &= a.$Orientation;
        a.$AutoCenter && n.W(f, m.rb, a.$AutoCenter);
        n.Ub(f)
    };
    ...
    var i = j.$JssorSlider$ = function() {
        ...
        var Gb = "data-jssor-slider",
            Wb = "data-jssor-thumb",
            v, n, U, lb, db, qb, cb, S, M, K, Qb, lc, pc = 1,
            kc = 1,
            Yb = 1,
            bc = {},
            y, Z, Eb, Sb, Pb, pb, sb, rb, kb, s = -1,
            Jb, q, I, H, fb, yb, zb, W, L, N, ab, x, X, xb, gb = [],
            gc, ic, cc, qc, Lc, u, mb, G, ec, wb, Hb, fc, R, Cb = 0,
            P = 0,
            J = Number.MAX_VALUE,
            E = Number.MIN_VALUE,
            hc, C, nb, T, O = 1,
        ...
        function xc(e, k, o) {
            ...
            l.$ScaleSize = function(q, p, t) {
                ...
                if (!f) {
                    ...
                    i = {
                        $Scale: b.U(e, m.Pb, 1),
                        $AutoCenter: b.U(e, m.rb)
                    };
                    b.$Each(n, function(c, a) {
                        j[a] = b.U(e, "data-scale-" + c, 1)
                    });
                    a = e;
                    if (k) {
                        a = b.$CloneNode(g, d);
                ...
                } else s = r = l = c.pow(M < K ? p : q, i.$Scale);
                b.ze(a, l);
        ...
        function Hc(m, f) {
            ...
            function A(a) {
                ...
                Q(m, a, 0);
                C = d;
                r = new db.$Class(m, db, b.U(m, "idle", ec), !u);
                r.M(0)
            }
            ...
            e.Lb = function(e, c) {
                ...
                if (x.length && !G) {
                    ...
                    b.qg(x, j, b.$CreateCallback(g, N, e, c))
                } else N(e, c)
            };
            e.Uf = function() {
                if (q == 1) {
                    ...
                    if (a) {
                        var h = eb = b.R(),
                            c = f + mb,
                            d = B[t(c)];
                        return d.Lb(b.$CreateCallback(g, S, c, d, a, h), w)
                    } else Ob(mb)
                }
            };
            e.zc = function() {
            ...
            function Q(a, f, c, h) {
                ...
                b.$Each(i, function(a) {
                    ...
                    if (g == "caption") {
                        if (f) {
                            b.ke(a, b.$AttributeEx(a, "to"));
                            b.Zd(a, b.$AttributeEx(a, "bf"));
                            J && b.$AttributeEx(a, "3d") && b.ae(a, "preserve-3d")
                        }
                    } else if (!C && !c && !j) {
                        if (e == "A") {
        ...
        function Gc(z, g, p, q) {
            ...
            function w() {
                b.Ac(V);
                qc && m && o.Jd && b.$AppendChild(V, o.Jd);
                b.A(V, !m && o.dc)
            }
            ...
            c.Yd = function(a) {
                p && b.Jb(ab, a && p.Kc.$Outside ? "" : "hidden")
            };
            c.qc = function(c, b) {
                if (m && b >= h) {
                    m = k;
        ...
        function Ab(l, g, m, o) {
            if (!A && (O || !(G & 12)) || n.$NaviQuitDrag) {
                ...
                if (!(C & 1)) {
                    if (o) a = t(a);
                    else if (C & 2 && (a < 0 && c.abs(b - E) < .0001 || a > q - N && c.abs(b - J) < .0001)) a = a < 0 ? J : E;
                    a = Db(a);
                    if (J - a < .5) a = J;
                    if (a - E < .5) a = E
                }
        ...
        a.Wb = function(Q, o) {
            ...
            b.$Each(s, function(a, d) {
                ...
                if (c == "loading") Z = a;
                    ...
                    if (a.tagName != "STYLE" && a.tagName != "SCRIPT") bc[c || d] = new xc(a, c == "slides", b.Uc(["slides", "thumbnavigator"])[c])
                }
            });
            Z = Z || b.$CreateDiv(h);
            sb = b.$CssWidth(y);
            ...
            b.Mb(ab, y);
            ib = new Ic;
            b.$AppendChild(ab, ib.jc);
            b.Jb(y, "hidden");
            G &= vb ? 10 : 5;
            var x = b.$Children(y),
                O = b.Uc(["DIV", "A", "LI"]);
            b.$Each(x, function(a) {
                O[a.tagName.toUpperCase()] && !b.$AttributeEx(a, "u") && hb.push(a);
                b.z(a, (b.z(a) || 0) + 1)
            });
            V = mc();
            b.$Css(V, "backgroundColor", "#000");
            b.xc(V, 0);
            b.z(V, 0);
            b.Mb(V, y.firstChild, y);
            q = hb.length;
            var m = c.ceil((i + fb) / W);
            if (n.$Cols) m = n.$Cols;
            L = c.min(q, m);
            ...
            if (q) {
                ...
                if (lb) {
                    qc = lb.$ShowLink;
                    Hb = lb.$Class;
                    fc = !R && L == 1 && q > 1 && Hb && (!b.$IsBrowserIE() || b.$BrowserVersion() >= 9)
                }
                if (!(C & 1)) {
                    P = R / W;
                    E = P;
                ...
                nb = (L > 1 || R ? U : -1) & n.$DragOrientation;
                Tb.Vd && b.$Css(y, Tb.Vd, ([g, "pan-y", "pan-x", "none"])[nb] || "");
                if (fc) D = new Hb(Mb, I, H, lb, vb, Ib);
                ...
                if (Eb && qb) {
                    gc = new qb.$Class(Eb, qb, M, K);
                    gb.push(gc)
                }
                if (cb && Sb && Pb) {
                    cb.$Loop = C;
                    ic = new cb.$Class(Sb, Pb, cb, M, K, a);
                    gb.push(ic)
                }
                if (pb && S) {
                    S.$StartIndex = n.$StartIndex;
                    S.$ArrowKeyNavigation = S.$ArrowKeyNavigation || 0;
                    cc = new S.$Class(pb, S);
                    !S.$NoDrag && b.$Attribute(pb, Wb, "1");
                    gb.push(cc)
                }
                b.$Each(gb, function(a) {
                    a.Gc(q, B, Z);
